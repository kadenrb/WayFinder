    ...
    <div className="landing">
      ...
      <main className="landing__main">
        <form className="card auth" onSubmit={onSubmit}>
          ...
          <p className="muted">Provide your email and a tag to receive updates. This does not create a sign-in account.</p>
          ...
          <div className="actions">
            ...
            <Link className="btn btn--ghost" to="/signin">Already have an account?</Link>
          </div>
        </form>
      </main>
    </div>
