      ...
      <div className="card-body">
        <div className="d-flex align-items-center justify-content-between mb-2" ref={rootRef}>
          ...
          <div className="d-flex align-items-center gap-2">
            ...
            <button className="btn btn-outline-secondary btn-sm" onClick={() => changeZoom(+0.1)}>+</button>
            <select className="form-select form-select-sm" value={detectorMode} onChange={(e)=>setDetectorMode(e.target.value)}>
        ...
        <div className="d-flex gap-2 mt-3 align-items-center flex-wrap">
          ...
          <button className="btn btn-warning" onClick={async()=>{
            if (detectorMode!== 'db') { setBusy('Switch detector to DB'); setTimeout(()=>setBusy(''),1500); return; }
          ...
          <div className="d-flex align-items-center ms-2">
            ...
            <input type="range" min="0.002" max="0.02" step="0.001" value={dupRadius} onChange={(e)=>setDupRadius(parseFloat(e.target.value))} style={{ width: 120 }} />
            <span className="ms-1 text-muted">{dupRadius.toFixed(3)}</span>
          </div>
          ...
          <div className="mt-3">
            ...
            <ul className="list-group">
              {points
                ...
                <li
                  key={p.id}
                  className={`list-group-item d-flex justify-content-between align-items-center ${selectedId === p.id ? "active" : ""}`}
